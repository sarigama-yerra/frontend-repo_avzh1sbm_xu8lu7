export default function Footer() {
  return (
    <footer className="bg-[#06070c] border-t border-white/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          <div>
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-cyan-400 via-indigo-400 to-fuchsia-500 ring-1 ring-white/30 animate-[pulse_5s_ease-in-out_infinite]" />
          ...
          <div>
            ...
            <form className="mt-3 flex gap-2">
              ...
              <button className="rounded-lg bg-white text-gray-900 px-3 py-2 font-medium hover:scale-[1.02] transition">Subscribe</button>
            </form>
          </div>
        </div>
